...
var _user$project$Components_Footer$organizerFooter = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$html$Html_Attributes$class('footer jumbotron')
		]),
	_elm_lang$core$Native_List.fromArray(
		[
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Organizer.io')
				]))
		]));

var _user$project$Components_Header$organizerHeader = A2(
	_elm_lang$html$Html$div,
	_elm_lang$core$Native_List.fromArray(
		[
		...
		[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('btn btn-primary label-warning')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html$text('Organizer')
						]))
				])),
			A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_elm_lang$html$Html$text('Organizer is the world best thing to use')
				]))
		]));
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[]),
				_elm_lang$core$Native_List.fromArray(
					[_user$project$Components_Header$organizerHeader, _user$project$Components_Footer$organizerFooter]))
			]));
};
